...
const Somos = ({ activeSubsection = null }) => {
  ...
  // Si hay una sección específica, mostrar solo esa
  const shouldShowSection = (sectionId) => {
    return currentSection === null || currentSection === sectionId
  }
    ...
    <section id="somos" className="min-h-screen section-padding bg-gradient-to-b from-gray-50 via-white to-gray-50 relative pt-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="section-container-premium p-8 md:p-12">
          ...
          {/* Header - Solo mostrar si no hay sección específica */}
          {!currentSection && (
            <motion.div
          ...
          {/* INSTITUCIONES */}
          {shouldShowSection('instituciones') && (
            <motion.div
              id="instituciones"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* Botón para volver a ver todas las secciones */}
          {currentSection && (
            <motion.div
              initial={{ opacity: 0, y: 30 }}
